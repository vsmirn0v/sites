...
<p>{current_time} LA: <b>{load_avg['1_min']}</b> {load_avg['5_min']} {load_avg['15_min']} RAM: <b>{memory_utilization}%</b> xray uptime: <b>{xray_uptime}h</b> connections: <b>{network_connections['established']}</b> waiting: {network_connections['non_established']} generated in {elapsed_time:.2f} seconds</p>
<table>
    <tr>
        <th>IP Address</th>
        <th>Count</th>
